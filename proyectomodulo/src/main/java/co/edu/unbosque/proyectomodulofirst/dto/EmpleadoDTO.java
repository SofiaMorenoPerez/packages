...
/**
 * DTO base que representa a un empleado del sistema.
...
public class EmpleadoDTO {
     ...
     */
    public EmpleadoDTO(String nombre, int edad, LocalDateTime fechaInicio) {
        super();
        this.nombre = nombre;
        this.edad = edad;
    ...
    public String toString() {
        return "EmpleadoDTO [id=" + id + ", nombre=" + nombre + ", edad=" + edad + ", fechaInicio=" + fechaInicio + "]";
    }
