...
/**
 * Entidad que representa un paquete dentro del sistema de envíos.
...
public class Paquete {
    ...
    private @Enumerated(EnumType.STRING) TipoDePaquete tipo;
    private double peso;
     ...
     */
    public Paquete(long idUsuario, long idConductor, long idManipulador, String ciudadDeOrigen,
    ...
    /**
     * Calcula el tiempo restante en minutos para la entrega del paquete.
     * Toma como referencia la fecha de envío más el máximo de horas permitido.
     *
    ...
    public String toString() {
        return "Paquete [id=" + id + ", idUsuario=" + idUsuario + ", idConductor=" + idConductor
                ...
                + ", tipo=" + tipo + ", peso=" + peso + ", maxHoras=" + maxHoras + "]";
    }

    @Override
    public int hashCode() {
        return Objects.hash(ciudadDeDestino, ciudadDeOrigen, direccionDeDestino, direccionDeOrigen,
                fechaEnvio, id, idConductor, idManipulador, idUsuario, maxHoras, peso, tipo);
    }
