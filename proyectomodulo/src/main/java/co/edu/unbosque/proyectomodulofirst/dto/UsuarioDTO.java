...
/**
 * DTO que representa a un usuario del sistema de envíos.
...
public class UsuarioDTO {
     ...
     */
    public UsuarioDTO(String nombre, TipoDeUsuario tipo, String ciudad, String direccion, long telefono) {
        super();
        this.nombre = nombre;
        this.tipo = tipo;
        this.ciudad = ciudad;
    ...
    public String toString() {
        return "UsuarioDTO [id=" + id + ", nombre=" + nombre + ", tipo=" + tipo + ", tarifa=" + tarifa
